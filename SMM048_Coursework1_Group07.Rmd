...
Using the above steps we have selected the following models:

TS1: **ARIMA(2,0,1)** is selected over ARIMA(2,0,2) suggested by auto.arima because of better AIC and BIC, i.e better fit and more parsimonious.

TS2: **ARIMA(2,0,3)** as suggested by auto.arima is selected because other candidate models with smaller BIC all exhibit serial correlation according to Ljung-Box tests.

TS3: **ARIMA(2,1,0)** from auto.arima already has the best AIC and BIC.
