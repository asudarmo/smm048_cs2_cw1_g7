...
To determine the appropriate number of factors, parallel analysis, principal component analysis (PCA), and the scree plot in Figure \@ref(fig:Q1plot1) were examined. The scree plot shows a sharp decline in eigenvalues for the first components (5.13, 2.75, 2.14, 1.85, 1.55, and 1.07). According to the Kaiser criterion (eigenvalue > 1), up to six components could be retained. However, the sixth eigenvalue is only slightly above the threshold, and the scree plot levels off after the fifth component, suggesting that additional components contribute little to explaining the overall variance. Considering these results, a five-factor solution was selected. For completeness, the comparison between the five- and six-component solutions obtained using PCA is provided in the Appendix.
...
```{r Q1plot1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap=" parallel analysis and Scree plot for determining the number of factors", fig.show='hold', fig.align='center', fig.pos='H', fig.width=6.2, fig.height=3, fig.pos='H', out.width='90%'}
...
``` {r q1plot2, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Rotated Factor loadings(Varimax vs Promax)", fig.show='hold', fig.align='center', fig.pos='H', fig.width=6.2, fig.height=3, fig.pos='H', out.width='90%'}
